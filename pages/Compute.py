...
def parse(filename_input):
   ...
   # .parse(filename_input) # "./" + filename_input )
    ...
    return flight, time, aircraft, fms_route_name, dep_airport_name, arr_airport_name
...
if uploaded_file is not None: 
    ...
    f, t, ac, route, dep_airport, arr_airport = parse(t) 
        ...
        with tab2:
            ...
            with col1:
                with st.form("my_form"):
                    ...
                    non_volatile_emissions_index_input = st.text_input('Emissions Index', value=1500000000000000)
                    n_engine_input = 2
