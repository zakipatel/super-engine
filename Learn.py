        ...
        with col2:
            if run:
                ...
                flight_attrs = {
                    ...
                    "wingspan": 37.57, #df_flight["Wingspan (m)"].values[0],
                    "nvpm_ei_n": non_volatile_emissions_index_input
                }
                ...
                era5pl = ERA5(
                   ...
                   key='f753ba5c-08c7-415a-b9f1-ebcb5a47a0a2'
                )
                ...
                #m = client.retrieve(dataset, request, target)
                #st.write(type(m))
                #st.write(client)

                met = era5pl.open_metdataset()
                status_string = "2   Getting RAD Data..."
                st.write(status_string)
                ...
                # flight_statistics = cocip.s` output_flight_statistics()
                ...
                flight_statistics = contrail_flight_summary_statistics(waypoint_summary)
                st.write(flight_statistics)
                #st.write(waypoint_summary)
                x = fl_out.dataframe
                ...
                if flight_statistics is not None:
                    st.write("Results")
                    total_contrail_EF = flight_statistics['total_contrails_formed']
                    st.write(total_contrail_EF) 
                    #st.plot(x.plot(x="time", y="rhi"))
                    st.line_chart(x, x="time", y="rhi")
